...
import 'package:ecommerce_practice_app/presentation/screens/order/providers/order_detail_provider.dart';
          ...
          PrimaryButton(
              onPressed: () async {
                ...
                if (newOrder.status == "payment-pending") {
                  await RazorPayServices.checkoutOrder(newOrder, onSuccess: (response) async {
